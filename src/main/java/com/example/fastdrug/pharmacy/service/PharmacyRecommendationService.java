...
import com.example.fastdrug.api.service.KakaoAddressSearchService;
import com.example.fastdrug.direction.dto.OutputDto;
import com.example.fastdrug.direction.entity.Direction;
import com.example.fastdrug.direction.service.Base62Service;
...
public class PharmacyRecommendationService {
    ...
    public List<OutputDto> recommendPharmacyList(String address) {
        ...
        System.out.println("▶ kakaoApiResponseDto ◀ " + kakaoApiResponseDto.getDocumentDtoList().toString());
